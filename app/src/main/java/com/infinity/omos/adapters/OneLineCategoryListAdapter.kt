...
class OneLineCategoryListAdapter internal constructor(context: Context, myRecord: List<MyRecord>?):
    ListAdapter<MyRecord, OneLineCategoryListAdapter.ViewHolder>(
        OneLineCategoryDiffUtil
    ){
    ...
    companion object OneLineCategoryDiffUtil: DiffUtil.ItemCallback<MyRecord>(){
